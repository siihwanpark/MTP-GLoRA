...
@auto_docstring
class LlamaForCausalLM(LlamaPreTrainedModel, GenerationMixin, DistributedModel):
    ...
    def resize_token_embeddings(self, new_num_tokens: int) -> nn.Embedding:
        ...
        Note that here we always initialize new embeddings with the mean of the old embeddings.
        Any kind of randomness is not involved for the reproducibility.
        """
    ...
    def _get_resized_embeddings(self, old_embeddings, new_num_tokens):
        ...
        if new_num_tokens > old_num_tokens:
            ...
            self._init_added_embeddings_weights_with_mean(old_embeddings, new_embeddings, added_num_tokens)
    ...
    def _init_added_embeddings_weights_with_mean(
        self, old_embeddings, new_embeddings, added_num_tokens
    ):
        mean_embeddings = torch.mean(old_embeddings.weight.data.to(torch.float32), axis=0)
